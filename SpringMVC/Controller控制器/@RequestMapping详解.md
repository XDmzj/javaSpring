...
其实从它的名字我们也能得知，此注解就是将请求和处理请求的方法建立一个映射关系，当收到请求时就可以根据映射关系调用对应的请求处理方法，

# `@RequestMapping`
那么我们就来先聊聊`@RequestMapping`吧，注解定义如下：
...
![image-20230220152559862](https://oss.itbaima.cn/internal/markdown/2023/02/20/JVwN2MhrWBAGni9.png)

我们也可以使用衍生注解@PostMapping直接设定为指定类型的请求映射：
